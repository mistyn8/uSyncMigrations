...
namespace www.Extensions.PropertyEditors
{
    ...
    /// </summary>
    internal class TsdMultipleTextStringConfigurationEditor : ConfigurationEditor<MultipleTextStringConfiguration>
    {
        public TsdMultipleTextStringConfigurationEditor(IIOHelper ioHelper) : base(ioHelper)
        {

...
namespace www.Extensions.PropertyEditors
{
    ...
    /// </summary>
    [DataEditor(
        alias: "TsdMultipleTextstring",
        name: "Tsd Repeatable textstrings",
        view: "~/App_Plugins/TSD/PropertyEditors/multipletextbox.html",
        ValueType = ValueTypes.Text,
        Group = Constants.PropertyEditors.Groups.Lists,
        Icon = "icon-ordered-list")]
    public class TsdMultipleTextStringPropertyEditor : DataEditor
    {
        private readonly IIOHelper _ioHelper;

        /// <summary>
        /// Initializes a new instance of the <see cref="TsdMultipleTextStringPropertyEditor"/> class.
        /// </summary>
        public TsdMultipleTextStringPropertyEditor(
            IIOHelper ioHelper,
        ...
        /// <inheritdoc />
        protected override IConfigurationEditor CreateConfigurationEditor() => new TsdMultipleTextStringConfigurationEditor(_ioHelper);
